...
public class QQEmail {
    ...
    public void sendMessage() throws GeneralSecurityException, MessagingException {
        ...
        //邮件的文本内容
        message.setContent("学号：" + "'" + student.getID() + "'" + "<br>" + "姓名：" + "'" + student.getName() + "'" + "<br>" + "性别：" + "'" + student.getSex() + "'" + "<br>" + "第一志愿：" + "'" + student.getIntentionFirst() + "'" + "<br>" + "第二志愿：" + "'" + student.getIntentionSecond() + "'" + "<br>" + "学院：" + "'" + student.getCollege() + "'" + "<br>" + "专业：" + "'" + student.getMajor() + "'" + "<br>" + "电话号码：" + "'" + student.getPhoneNumber() + "'" + "<br>" + "QQ号：" + "'" + student.getQQNumber() + "'" + "<br>" + "自我介绍：" + "'" + student.getIntroduction() + "'" + "<br>" + "如果信息有误可重新提交或者联系管理员" + MyQQ, "text/html;charset=UTF-8");
        //5.发送邮件
